#In case the built-in Pytorch geometric modules does not contain the required data module (which happened)
#Place this file under envs\<env name>\Lib\site-packages\torch_geometric\datasets 
#for manualy download datasets
